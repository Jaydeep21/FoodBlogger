<html>
	...
	<body >
        ...
        <div class="loginbox" style="width: 320px;height: 730px;top:70%">
            <h1>Upload</h1>
            <form  action="../assets/php/upload.php" method="post" onsubmit="return checkUpload(this);">
                ...
                <p>Recepie:</p>
                <input type="file" name="rtxt">
                <p>Or</p>
                <textarea type="textarea" style="height: 70px;width:250px;text-allign:center;" placeholder="Enter your Recepie..." name="recepie"></textarea>
                <br>
                <br>
                <p>Description:</p>
